...
if __name__ == '__main__':
    ...
    How to run:
    E.g.
    >> python generate_logit_output.py -f encs/encs_majority_test_blind.tsv -d model_2021_07_26_11_46_10_encs/ -n filename.txt
    >> python generate_logit_output.py -f data_with_SEN_feature/enzh_majority_test_blind.tsv -d model_2021_07_26_11_46_10_enzh/ -n filename.txt
